...
RANDOM_COLOR0 = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
...
RANDOM_COLOR4 = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
RANDOM_COLOR5 = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
RANDOM_COLOR6 = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
RANDOM_COLOR7 = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
...
RANDOM_COLORS = [RANDOM_COLOR0, RANDOM_COLOR1, RANDOM_COLOR2, RANDOM_COLOR3, RANDOM_COLOR4,
                 RANDOM_COLOR5, RANDOM_COLOR6, RANDOM_COLOR7, RANDOM_COLOR8, RANDOM_COLOR9]
