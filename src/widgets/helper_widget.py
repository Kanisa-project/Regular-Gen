...
class HelpingWidget(ttk.LabelFrame):
    def __init__(self, width, height, master=None, idutc=None, texioty=None, text="Basic"):
        """
    ...
    def setup_slider_bars(self, slider_list: list, start_x_cell=0, start_y_cell=0, slide_len=88):
        ...
        for i, parameter in enumerate(slider_list):
            ...
            row = i % 8
            col = i // 10
            scale.grid(column=start_x_cell + col, row=row + start_y_cell, sticky="s", columnspan=4)
