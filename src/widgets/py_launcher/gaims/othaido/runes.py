...
class Rune:
    def __init__(self):
        ...
        self.germanic = "None"
        self.english = "None"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "blank.png")).convert()
...
class Fehu(Rune):
    def __init__(self):
        ...
        self.germanic = "Fehu"
        self.english = "fee"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "fehu.png")).convert()
...
class Uruz(Rune):
    def __init__(self):
        ...
        self.germanic = "Uruz"
        self.english = "urox"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "uruz.png")).convert()
...
class Thurisaz(Rune):
    def __init__(self):
        ...
        self.english = "thorn"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "thurisaz.png")).convert()
...
class Ansuz(Rune):
    def __init__(self):
        ...
        self.germanic = "Ansuz"
        self.english = "Ans"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "ansuz.png")).convert()
...
class Raidho(Rune):
    def __init__(self):
        ...
        self.english = "Riding"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "raidho.png")).convert()
...
class Kenaz(Rune):
    def __init__(self):
        ...
        self.germanic = "Kenaz"
        self.english = "keen"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "kenaz.png")).convert()
...
class Gebo(Rune):
    def __init__(self):
        ...
        self.germanic = "Gebo"
        self.english = "gift"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "gebo.png")).convert()
...
class Wunjo(Rune):
    def __init__(self):
        ...
        self.germanic = "Wunjo"
        self.english = "wyn"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "wunjo.png")).convert()
...
class Hagalaz(Rune):
    def __init__(self):
        ...
        self.english = "Hail"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "hagalaz.png")).convert()
...
class Nauthiz(Rune):
    def __init__(self):
        ...
        self.english = "Need"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "nauthiz.png")).convert()
...
class Isa(Rune):
    def __init__(self):
        ...
        self.germanic = "Isa"
        self.english = "Ice"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "isa.png")).convert()
...
class Jera(Rune):
    def __init__(self):
        ...
        self.germanic = "Jera"
        self.english = "Year"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "jera.png")).convert()
...
class Eihwaz(Rune):
    def __init__(self):
        ...
        self.english = "Yew"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "eihwaz.png")).convert()
...
class Perthro(Rune):
    def __init__(self):
        ...
        self.english = "Perd"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "perthro.png")).convert()
...
class Elhaz(Rune):
    def __init__(self):
        ...
        self.germanic = "Elhaz"
        self.english = "Elks"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "elhaz.png")).convert()
...
class Sowilo(Rune):
    def __init__(self):
        ...
        self.english = "Sun"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "sowilo.png")).convert()
...
class Tiwaz(Rune):
    def __init__(self):
        ...
        self.germanic = "Tiwaz"
        self.english = "Teu"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "tiwaz.png")).convert()
...
class Berkano(Rune):
    def __init__(self):
        ...
        self.english = "Birch"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "berkano.png")).convert()
...
class Ehwaz(Rune):
    def __init__(self):
        ...
        self.germanic = "Ehwaz"
        self.english = "Eh"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "ehwaz.png")).convert()
...
class Mannaz(Rune):
    def __init__(self):
        ...
        self.english = "Man"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "mannaz.png")).convert()
...
class Laguz(Rune):
    def __init__(self):
        ...
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "laguz.png")).convert()
...
class Ingwaz(Rune):
    def __init__(self):
        ...
        self.english = "Ing"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "ingwaz.png")).convert()
...
class Dagaz(Rune):
    def __init__(self):
        ...
        self.germanic = "Dagaz"
        self.english = "Day"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "dagaz.png")).convert()
...
class Othala(Rune):
    def __init__(self):
        ...
        self.english = "Odal"
        self.elder_form = pygame.image.load(os.path.join(img_folder, img_folder, "othala.png")).convert()
