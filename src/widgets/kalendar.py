...
@dataclass
class EventDataCard:
    eventType: models.DisplayComponent
    eventDate: models.DisplayComponent
    eventTime: models.DisplayComponent
    eventCreator: models.DisplayComponent
    eventCreatedUTC: models.DisplayComponent
...
class Kalendar(helper_widget.HelpingWidget):
    ...
    def prev_month_btn_press(self):
        if self.month_num == 1:
            ...
            self.month_num -= 1
        self.month_num = helpers.clamp(self.month_num, 1, 12)
        self.selected_month_var.set(months[self.month_num - 1])
        self.create_day_buttons([])
