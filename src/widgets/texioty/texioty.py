...
from src.widgets.texioty import texity, texoty, msg_client
...
class TEXIOTY(tk.LabelFrame):
    def __init__(self, width, height, master=None):
        ...
        self.available_profiles = theme.available_profiles
        ...
        self.texioty_commands = {
            "help": [self.display_help_message, "Displays a message of hope and help.",
                     {"TXTY": "Texioty, the main attraction.",
                      ...
                      "MUJC": "Mujic playing for a user."}, "TXTY", theme.rgb_to_hex(theme.INDIAN_RED), theme.rgb_to_hex(theme.BLACK)],
            "exit": [self.close_program, "Exits the program.",
                     {}, "TXTY", theme.rgb_to_hex(theme.INDIAN_RED), theme.rgb_to_hex(theme.BLACK)],
            ...
            "login": [self.log_profile_in, "This logs the user into a profile: ",
                      {'guest': "Basic account with a few permissions."}, "TXTY", theme.rgb_to_hex(theme.LIGHT_GREEN),
                      theme.rgb_to_hex(theme.BLACK)],
            "logout": [self.log_profile_out, "This logs the user out of a profile.",
                       {}, "TXTY", theme.rgb_to_hex(theme.LIGHT_GREEN), theme.rgb_to_hex(theme.BLACK)],
    ...
    def execute_command(self, command, arguments):
        ...
        if self.in_play_gaim_mode or self.in_questionnaire_mode or command == "tex8":
            ...
            self.texoty.priont_string("⦓⦙ " + helpers.random_loading_phrase())
    ...
    ├fotoes » Gather fotoes option...  ◄╡  The argument is separated from its
